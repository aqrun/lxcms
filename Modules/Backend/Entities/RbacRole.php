...
use Modules\Backend\Entities\Traits\RbacHasPermissions;
use Spatie\Permission\Exceptions\RoleDoesNotExist;
use Spatie\Permission\Exceptions\GuardDoesNotMatch;
use Spatie\Permission\Exceptions\RoleAlreadyExists;
use Modules\Backend\Contracts\Role as RoleContract;
...
class RbacRole extends Model implements RoleContract
{
     ...
     */
    public static function findOrCreate(string $name, string $slug, $guardName = null): RoleContract
    {
        $guardName = $guardName ?? Guard::getDefaultName(static::class);
        ...
        if (! $role) {
            return static::create(['name' => $name, 'slug' => $slug, 'guard_name' => $guardName]);
        }
