...
namespace Modules\Backend\Entities\Traits;

use Illuminate\Support\Collection;
use Modules\Backend\Contracts\Role;
...
trait RbacHasRoles
{
    ...
    public function hasAllRoles($roles): bool
    {
        ...
        return $roles->intersect($this->roles->pluck('slug')) == $roles;
    }
    ...
    protected function getStoredRole($role): Role
    {
        ...
        if (is_string($role)) {
            return app(Role::class)->findBySlug($role, $this->getDefaultGuardName());
        }
